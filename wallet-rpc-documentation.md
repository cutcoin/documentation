...
This is a list of the cutcoin-wallet-rpc calls, their inputs and outputs, and examples of each. The program cutcoin-wallet-rpc replaced the rpc interface that was in simplewallet and then cutcoin-wallet-cli.

All cutcoin-wallet-rpc methods use the same JSON RPC interface. For example:
...
If the cutcoin-wallet-rpc was executed with the `--rpc-login` argument as `username:password`, then follow this example:
...
*   _balance_ - unsigned int; The total balance of the current cutcoin-wallet-rpc in session.
*   _unlocked_balance_ - unsigned int; Unlocked funds are those funds that are sufficiently deep enough in the Cutcoin blockchain to be considered safe to spend.
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_balance","params":{"account_index":0,"address_indices":[0,1]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
*   _address_ - string; The 95-character hex address string of the cutcoin-wallet-rpc in session.
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_address","params":{"account_index":0,"address_index":[0,1,4]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_address_index","params":{"address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"create_address","params":{"account_index":0,"label":"new-sub"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"label_address","params":{"index":{"major":0,"minor":5},"label":"myLabel"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_accounts","params":{"tag":"myTag"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"create_account","params":{"label":"Secondary account"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"label_account","params":{"account_index":0,"label":"Primary account"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_account_tags","params":""}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"tag_accounts","params":{"tag":"myTag","accounts":[0,1]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"untag_accounts","params":{"accounts":[1]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"set_account_tag_description","params":{"tag":"myTag","description":"Test tag"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
*   _height_ - unsigned int; The current cutcoin-wallet-rpc's blockchain height. If the wallet has been offline for a long time, it may need to catch up with the daemon.

Example:


    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_height"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Send cutcoin to a number of recipients.

Alias: _None_.

Inputs:

*   _destinations_ - array of destinations to receive CUT:
...
*   _unlock_time_ - unsigned int; Number of blocks before the cutcoin can be spent (0 to not add a lock).
*   _get_tx_key_ - boolean; (Optional) Return the transaction key after sending.
*   _do_not_relay_ - boolean; (Optional) If true, the newly created transaction will not be relayed to the cutcoin network. (Defaults to false)
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"destinations":[{"amount":100000000000,"address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7"},{"amount":200000000000,"address":"75sNpRwUtekcJGejMuLSGA71QFuK1qcCVLZnYRTfQLgFU5nJ7xiAHtR5ihioS53KMe8pBhH61moraZHyLoG4G7fMER8xkNv"}],"account_index":0,"subaddr_indices":[0],"priority":0,"ring_size":7,"get_tx_key": true}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer_split","params":{"destinations":[{"amount":1000000000000,"address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7"},{"amount":2000000000000,"address":"75sNpRwUtekcJGejMuLSGA71QFuK1qcCVLZnYRTfQLgFU5nJ7xiAHtR5ihioS53KMe8pBhH61moraZHyLoG4G7fMER8xkNv"}],"account_index":0,"subaddr_indices":[0],"priority":0,"ring_size":7,"get_tx_keys": true}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Generate unsigned_txset using the above "transfer" method on read-only wallet:
    ...
    curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"destinations":[{"amount":1000000000000,"address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7"}],"account_index":0,"subaddr_indices":[0],"priority":0,"ring_size":7,"do_not_relay":true,"get_tx_hex":true}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Sign tx using the previously generated unsigned_txset
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sign_transfer","params":{"unsigned_txset":...long_hex..."}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
In the example below, we submit the transfer using the signed_txset generated above:
    ...
    curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"submit_transfer","params":{"tx_data_hex":...long_hex..."}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example (In this example, `sweep_dust` returns nothing because there are no funds to sweep):
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sweep_dust","params":{"get_tx_keys":true}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sweep_all","params":{"address":"cutb9vuXgqtS2fDGRRptm8QHdQb4NQv1ZWBDhUCzQAjYcCggvgTcvSsZX6WetiXw1p3HpTgAhTdmniSRwzqKNPDW4mUQt5FZsW","subaddr_indices":[4],"ring_size":7,"unlock_time":0,"get_tx_keys":true}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
*   _fee_ - Integer value of the fee charged for the txn.
*   _tx_blob_ - Raw transaction represented as hex string, if get_tx_hex is true.
*   _tx_id_ - String for the publically searchable transaction hash.
...
Send specified token to an address.
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer_token","params":{"destinations":[{"amount":100000000000,"address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7", "token_id": 4705223981953712128},{"amount":200000000000,"address":"75sNpRwUtekcJGejMuLSGA71QFuK1qcCVLZnYRTfQLgFU5nJ7xiAHtR5ihioS53KMe8pBhH61moraZHyLoG4G7fMER8xkNv", "token_id": 4705223981953712128}],"account_index":0,"subaddr_indices":[0],"ring_size":7,"get_tx_key": true}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Return the wallet's token balances.

Alias: _None_.

Inputs:

*   _account_index_ - unsigned int; Return specified token balance for this account.
*   _address_indices_ - array of unsigned int; (Optional) Return balance detail for those subaddresses.
*   _token_id_ - unsigned int; Return balance for this token.
...
*   _prefix_ - string; Prefix to filter token names by starts_with(prefix).
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"relay_tx","params":{"hex":"...tx_metadata..."}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"store"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_payments","params":{"payment_id":"60900e5603bf96e3"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_bulk_payments","params":{"payment_ids":["60900e5603bf96e3"],"min_block_height":"120000"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example, get all transfers:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"incoming_transfers","params":{"transfer_type":"all","account_index":0,"subaddr_indices":[3]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example, get available transfers:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"incoming_transfers","params":{"transfer_type":"available","account_index":0,"subaddr_indices":[3]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example, get unavailable transfers:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"incoming_transfers","params":{"transfer_type":"unavailable","account_index":0,"subaddr_indices":[3]}}' -H 'Content-Type: application/json'
    {
    "id": "0",
    "jsonrpc": "2.0",
    "result": {
...
Example (Query view key):
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"query_key","params":{"key_type":"view_key"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example (Query mnemonic key):
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"query_key","params":{"key_type":"mnemonic"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example (Payment ID is empty, use a random ID):
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"make_integrated_address","params":{"standard_address":"cutb9vuXgqtS2fDGRRptm8QHdQb4NQv1ZWBDhUCzQAjYcCggvgTcvSsZX6WetiXw1p3HpTgAhTdmniSRwzqKNPDW4mUQt5FZsW"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"stop_wallet"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"rescan_blockchain"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"set_tx_notes","params":{"txids":["3292e83ad28fc1cc7bc26dbd38862308f4588680fbf93eae3e803cddd1bd614f"],"notes":["This is an example"]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_tx_notes","params":{"txids":["3292e83ad28fc1cc7bc26dbd38862308f4588680fbf93eae3e803cddd1bd614f"]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"set_attribute","params":{"key":"my_attribute","value":"my_value"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_attribute","params":{"key":"my_attribute"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_tx_key","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_tx_key","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","tx_key":"feba662cf8fb6d0d0da18fc9b70ab28e01cc76311278fdd7fe7ab16360762b06","address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_tx_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7","message":"this is my transaction"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
In the example below, the transaction has been proven:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_tx_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7","message":"this is my transaction","signature":"InProofV13vqBCT6dpSAXkypZmSEMPGVnNRFDX2vscUYeVS4WnSVnV5BwLs31T9q6Etfj9Wts6tAxSAS4gkMeSYzzLS7Gt4vvCSQRh9niGJMUDJsB5hTzb2XJiCkUzWkkcjLFBBRVD5QZ"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
In the example below, the wrong message is used, avoiding the transaction to be proved:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_tx_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","address":"ctsT6VcH4Djjob3xm7y16o6xKFAb2UYkU2LgGadosyAHa37GZpKk6hv6YrXenHjPAZEoMCe1ae5KxidqrzQkvEbHL9d6Km6xC7","message":"wrong message","signature":"InProofV13vqBCT6dpSAXkypZmSEMPGVnNRFDX2vscUYeVS4WnSVnV5BwLs31T9q6Etfj9Wts6tAxSAS4gkMeSYzzLS7Gt4vvCSQRh9niGJMUDJsB5hTzb2XJiCkUzWkkcjLFBBRVD5QZ"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_spend_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","message":"this is my transaction"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_reserve_proof","params":{"all":false,"account_index":0,"amount":100000000000}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
*   _spent_ - unsigned int; Amount (in atomic units) of the total that has been spent.
*   _total_ - unsigned int; Total amount (in atomic units) of the reserve that was proven.

In the example below, the reserve has been proven:


    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_reserve_proof","params":{"address":"cutb9vuXgqtS2fDGRRptm8QHdQb4NQv1ZWBDhUCzQAjYcCggvgTcvSsZX6WetiXw1p3HpTgAhTdmniSRwzqKNPDW4mUQt5FZsW","signature":""}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
In the example below, all wallet reserve has been proven:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_reserve_proof","params":{"address":"cutb9vuXgqtS2fDGRRptm8QHdQb4NQv1ZWBDhUCzQAjYcCggvgTcvSsZX6WetiXw1p3HpTgAhTdmniSRwzqKNPDW4mUQt5FZsW","message":"I have 10 at least","signature":"...signature..."}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_transfers","params":{"in":true,"account_index":1}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_transfer_by_txid","params":{"txid":"c36258a276018c3a4bc1f195a7fb530f50cd63a4fa765fb7c6f7f49fc051762a"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sign","params":{"data":"This is sample data to be signed"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"verify","params":{"data":"This is sample data to be signed","address":"cutb9vuXgqtS2fDGRRptm8QHdQb4NQv1ZWBDhUCzQAjYcCggvgTcvSsZX6WetiXw1p3HpTgAhTdmniSRwzqKNPDW4mUQt5FZsW","signature":"SigV14K6G151gycjiGxjQ74tKX6A2LwwghvuHjcDeuRFQio5LS6Gb27BNxjYQY1dPuUvXkEbGQUkiHSVLPj4nJAHRrrw3"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"export_outputs"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"import_outputs","params":{"outputs_data_hex":"...outputs..."}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"export_key_images"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://127.0.0.1:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"make_uri","params":{"address":"cutb9vuXgqtS2fDGRRptm8QHdQb4NQv1ZWBDhUCzQAjYcCggvgTcvSsZX6WetiXw1p3HpTgAhTdmniSRwzqKNPDW4mUQt5FZsW","amount":10,"payment_id":"420fa29b2d9a49f5","tx_description":"Testing out the make_uri function.","recipient_name":"el00ruobuob Stagenet wallet"}}'  -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
        "uri": "cutcoin:cutb9vuXgqtS2fDGRRptm8QHdQb4NQv1ZWBDhUCzQAjYcCggvgTcvSsZX6WetiXw1p3HpTgAhTdmniSRwzqKNPDW4mUQt5FZsW?tx_payment_id=420fa29b2d9a49f5&tx_amount=0.000000000010&recipient_name=el00ruobuob%20Stagenet%20wallet&tx_description=Testing%20out%20the%20make_uri%20function."
      }
    }
...
*   _uri_ - JSON object containing payment information:
    *   _address_ - string; Wallet address
    *   _amount_ - unsigned int; Integer amount to receive, in **atomic units** (0 if not provided)
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_address_book","params":{"entries":[0,1]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"delete_address_book","params":{"index":1}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"refresh","params":{"start_height":100000}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"rescan_spent"}' -H 'Content-Type: application/json'
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_languages"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Create a new wallet. You need to have set the argument "–wallet-dir" when launching cutcoin-wallet-rpc to make this work.
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"create_wallet","params":{"filename":"mytestwallet","password":"mytestpassword","language":"English"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Open a wallet. You need to have set the argument "–wallet-dir" when launching cutcoin-wallet-rpc to make this work.
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"open_wallet","params":{"filename":"mytestwallet","password":"mytestpassword"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"close_wallet"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"change_wallet_password","params":{"old_password":"theCurrentSecretPassPhrase","new_password":"theNewSecretPassPhrase"}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example for a non-multisig wallet:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"is_multisig"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"prepare_multisig"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"export_multisig_info"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"import_multisig_info","params":{"info":["...multisig_info..."]}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
*   _address_ - string; multisig wallet address.
*   _multisig_info_ - array of string; Multisig string to share with peers to create the multisig wallet.
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sign_multisig","params":{"tx_data_hex":"...multisig_txset..."}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"submit_multisig","params":{"tx_data_hex":"...tx_data_hex..."}}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
...
Example:
    ...
    $ curl http://localhost:24250/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_version"}' -H 'Content-Type: application/json'
    {
      "id": "0",
      "jsonrpc": "2.0",
      "result": {
